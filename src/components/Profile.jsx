...
export default function Profile() {
  ...
  const socialLinks = [
    { key: "github", icon: GithubIcon, href: "https://github.com/yourusername" },
    { key: "linkedin", icon: LinkedinIcon, href: "https://linkedin.com/in/yourusername" },
    { key: "instagram", icon: InstagramIcon, href: "https://instagram.com/yourusername" },
  ];
...
function InstagramIcon() {
  return (
    <svg className="h-4 w-4 text-dracula-fg/40 transition-colors group-hover:text-[#e4405f]" viewBox="0 0 24 24" fill="currentColor">
